...
extern "C" int publisher_main(int domainId, int sample_count)
{
    ...
    DataBus::pm_data_structDataWriter * pm_data_struct_writer = NULL;
    DataBus::pm_data_struct *instance = NULL;
    ReturnCode_t retcode;
    ...
    /*
    instance_handle = pm_data_struct_writer->register_instance(*instance);
    */

    /* Main loop */
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {

        printf("Writing DataBus::pm_data_struct, count %d\n", count);

        /* Modify the data to be sent here */

	instance->ecgValue = 123;
	instance->plethValue = count;
    ...
    /*
    retcode = pm_data_struct_writer->unregister_instance(
    ...
    */
    ...
    /* Delete data sample */
    retcode = DataBus::pm_data_structTypeSupport::delete_data(instance);
    if (retcode != RETCODE_OK) {
        printf("DataBus::pm_data_structTypeSupport::delete_data error %d\n", retcode);
    }
